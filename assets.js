...
const BG_NAMES = {
  ...
  bg_courtyard:  'facade',
  // ВРЕМЕННО: главы 3-6 (расширенные версии) вводят ещё 4 новых места,
  // для которых отдельных референсов тоже не было — переиспользуем
  // ближайшие по смыслу существующие картинки. Когда появятся
  // отдельные референсы — просто поменяй значение справа.
  bg_stairs:        'landing',    // лестничная клетка между этажами
  bg_archive:       'desk',       // архив с документами в подвале
  bg_booth_inside:  'livingroom', // квартира Григория (не сама будка)
  bg_garages:       'facade',     // гаражи во дворе
};
